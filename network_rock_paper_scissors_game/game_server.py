...
def send_receive_client_message(client_connection, client_ip_addr):
    ...
    if len(clients) > 1:
        ...
        # send opponent name
        clients[0].send(("opponent_name$" + clients_names[1]).encode('utf-8'))
        clients[1].send(("opponent_name$" + clients_names[0]).encode('utf-8'))
        # go to sleep
    ...
    while True:
        ...
        if len(player_data) == 2:
            ...
            player_data[0].get("socket").send(("$opponent_choice" + player_data[1].get("choice")).encode('utf-8'))
            player_data[1].get("socket").send(("$opponent_choice" + player_data[0].get("choice")).encode('utf-8'))
